  ...
  return (
    ...
    <div className='row'> 
        <div className='col-sm-12'>
          <h1 className="text-center oxygen-bold" style={{ color: 'white', fontSize: 50 }}>Projects</h1>
          <p style={{color: '#739fe6', fontSize: 20}}>These are my personal projects that I am currently working on</p>
        </div>
      </div>
    ...
    <div className='row'>
        <div className='col-sm-12'>
            ...
            <div className='boxProject'>
                <div className="d-flex align-items-center">
                    <div>
                        <h1 style={{color: '#033559'}}> ML Project </h1>
                        <p style={{ fontFamily: 'Open Sans, sans-serif', fontWeight: 'bold', fontSize: 20, color: 'black' }}>
                          DevTrex is a business club that strives to teach students about the world of buisness, such as consulting, financial literacy, supply chain... (Website is WIP)
                        </p>
                    </div>
